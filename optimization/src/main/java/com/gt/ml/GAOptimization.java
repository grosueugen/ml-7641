...
public class GAOptimization {
	...
	private static Logger log = LoggerFactory.getLogger(GAOptimization.class);
    ...
    private StandardGeneticAlgorithm alg;
    ...
    public GAOptimization(int iterations) {
	...
	private void init() {
	    ...
	    alg = new StandardGeneticAlgorithm(200, 100, 10, pb);
	}
	...
	public static void main(String[] args) {
		...
		GAOptimization ga = new GAOptimization(iterations);
		log.info("Start GA, using {} iterations", iterations);
		ga.train();
		Map<Integer, AccuracyResult> trainingAccuracy = ga.getTrainingAccuracy();
		Map<Integer, AccuracyResult> testAccuracy = ga.getTestAccuracy();
